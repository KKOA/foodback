    ...
    <div class="col-12 offset-md-1 col-md-10 my-card active-filters-card pb-3">
        ...
        <div class="row mb-2 remove-bs-padding">
            <div class="col-12 col-md-3 col-lg-2  pt-2 pr-0 pl-0 text-md-right">
                <span class="font-weight-bold mt-1 mb-1 active-filter-type-header">Cuisine:</span>
            </div>
            <div class="col-12 col-md-9 col-lg-10 col-xl-4 text-md-left pl-2 pr-2" >
                @for(;$myCount <= 3; $myCount++)
                <span class="active-filter">
                    <a href="#">{{$cuisines->find($myCount)->name}} <i class="fas fa-times-circle"></i></a>
                </span>
                @endfor
            </div>
            <div class="col-12 col-md-3 col-lg-2  pt-2 pr-0 pl-0 text-md-right">
...
<div class="sidebar main left myfilter" id="sidebar-main">
    ...
    <div class="wrapper">
        ...
        {{-- Cusines --}}
        <p class="filter-title font-weight-bold cuisine-filter-header"><a href="#">Cuisines</a></p>                
        ...
        {{-- Features --}}
        <p class="filter-title font-weight-bold"><a href="#">Features</a></p>
        <ul class="cuisine-filter filter-options d-none"> 
        ...
        {{-- Serving Times --}}
        <p class="filter-title font-weight-bold"><a href="#">Serving Times</a></p>
        <ul class="cuisine-filter filter-options d-none"> 
        ...
        <p class="mt-5"><a href="#">Clear all filters</a></p>
    </div>
</div><!--#sidebar-main-->
